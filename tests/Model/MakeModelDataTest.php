...
class MakeModelDataTest extends \PHPUnit_Framework_TestCase
{
    public function testJSONInfoData()
    {
        ...
        $this->assertSame('2Good', $makeModels[0]->brandName());
        $this->assertSame('Pro 2', $makeModels[0]->modelName());
        $this->assertSame('', $makeModels[0]->marketingName());

        $this->assertSame('QiKU', $makeModels[1]->brandName());
        ...
        $this->assertSame('QiKU', $serialized['brand_name']);
    }
}
